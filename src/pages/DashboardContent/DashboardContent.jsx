...
const DashboardContent = () => {
  ...
  const handleResumeUpload = () => {
    ...
    setIsResumeUploaded(true); // Set to true once the resume is uploaded
  };
      ...
      <div className="grid grid-cols-4 gap-4 items-center justify-center">
        <div className="col-span-3">
          ...
          <p className="text-md leading-7">
            ...
            in the web sphere and help people with their online presence.
          </p>
        </div>
        <div className="border-2 flex flex-col items-center justify-center gap-3 mt-16 p-3 shadow rounded-md">
          <img src={img} alt="" />
          <p className="font-bold text-[crimson] animate-bounce">Apply Date : 15-09-2024</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 items-center justify-center mb-2">
        <div className="card border border-[#172539] h-72 w-full mt-2 p-5 rounded-sm">
          <Stepper
            ...
            continueBtn={
              isResumeUploaded ? (
                <button className="stepperBtn">Next</button>
              ) : (
                <button className="stepperBtn-pending" disabled>
                  Disable
                </button>
              )
            }
